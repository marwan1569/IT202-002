...
<tr><td> <em>Generated: </em> 2/12/2022 6:58:26 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/m2-php-hw/grade/mb25" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98278984/153732263-7e3b4531-fc8b-4ca6-b44c-bfcc924a26fb.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>problem 1 code + output  when deployed<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>This problem was fairly simple. I first made a foreach loop that went<br>through the arrays then I checked if each number in the array is<br>even by doing number remainder 2. if  num % 2 is zero,<br>its an even number so I put echo null. else (nothing else but<br>odd numbers) print out the number.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98278984/153732350-2ec3f4f4-66ed-4644-b8be-90e68a7f81c4.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>problem 2 code + output  when deployed<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>This was a little challenging because for some reason I didn&#39;t know how<br>to output the rounded numbers. Thanks to the prof, he gave me some<br>a tool I could use to output 2 rounded decimal places. I did<br>a foreach loop which went through the array, and each number in the<br>array gets added to the variable total. then I did number_format(total,2) and it<br>worked instead of just round()<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98278984/153732423-969c5e22-fd70-48e9-a0ad-9f17862c2033.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>problem 3 code + output  when deployed<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>this one was pretty easy tbh. just did a foreach loop (again lol)<br>and checked if the # was negative (num&lt;0) and if was true, I<br>multiplied that number by -1 to make it positive. I also used &quot;<br>&quot;<br>only to try it out :))<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://mb25-prod.herokuapp.com/M2/problem1.php">https://mb25-prod.herokuapp.com/M2/problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://mb25-prod.herokuapp.com/M2/problem2.php">https://mb25-prod.herokuapp.com/M2/problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://mb25-prod.herokuapp.com/M2/problem3.php">https://mb25-prod.herokuapp.com/M2/problem3.php</a> </td></tr>
<tr><td> <em>Sub-Task 4: </em> Pull Request URL for M2-PHP-HW to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/marwan1569/IT202-002/pull/3">https://github.com/marwan1569/IT202-002/pull/3</a> </td></tr>
<tr><td> <em>Sub-Task 5: </em> Talk about what you learned, any issues you had, how you resolve them</td></tr>
<tr><td> <em>Response:</em> <p>honestly, this course is lit. I got some PHP practice going on and<br>I had to do some research on some functions and whatnot. I had<br>an issue with the code itself, but thank to the time I spent<br>thinking and the help of the prof, I got it :)) <br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/m2-php-hw/grade/mb25" target="_blank">Grading</a></td></tr></table>